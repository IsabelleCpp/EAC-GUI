...
const inline auto GH_INJ_EXE_LAUNCHA = std::string("EasyAntiCheat.exe");
const inline auto GH_INJ_EXE_LAUNCHW = std::wstring(L"EasyAntiCheat.exe");

const inline auto GH_INJ_EXE_NAME64A = std::string("EasyAntiCheat_x64.exe");
const inline auto GH_INJ_EXE_NAME64W = std::wstring(L"EasyAntiCheat_x64.exe");

const inline auto GH_INJ_EXE_NAME86A = std::string("EasyAntiCheat_x86.exe");
const inline auto GH_INJ_EXE_NAME86W = std::wstring(L"EasyAntiCheat_x86.exe");

const inline auto GH_INJ_MOD_NAME64A = std::string("EasyAntiCheat_x64.dll");
const inline auto GH_INJ_MOD_NAME64W = std::wstring(L"EasyAntiCheat_x64.dll");

const inline auto GH_INJ_MOD_NAME86A = std::string("EasyAntiCheat_x86.dll");
const inline auto GH_INJ_MOD_NAME86W = std::wstring(L"EasyAntiCheat_x86.dll");

const inline auto GH_INJ_SM_NAME64A = std::string("EasyAntiCheat SM_x64.exe");
const inline auto GH_INJ_SM_NAME64W = std::wstring(L"EasyAntiCheat SM_x64.exe");

const inline auto GH_INJ_SM_NAME86A = std::string("EasyAntiCheat SM_x86.exe");
const inline auto GH_INJ_SM_NAME86W = std::wstring(L"EasyAntiCheat SM_x86.exe");

const inline auto GH_INJ_DNP_NAME64A = std::string("EasyAntiCheat DNP_x64.dll");
const inline auto GH_INJ_DNP_NAME64W = std::wstring(L"EasyAntiCheat DNP_x64.dll");

const inline auto GH_INJ_DNP_NAME86A = std::string("EasyAntiCheat DNP_x86.dll");
const inline auto GH_INJ_DNP_NAME86W = std::wstring(L"EasyAntiCheat DNP_x86.dll");

const inline auto GH_INJ_DOTNET_PARSERA = std::string("EasyAntiCheatDotNET.exe");
const inline auto GH_INJ_DOTNET_PARSERW = std::wstring(L"EasyAntiCheatDotNET.exe");

const inline auto GH_INJ_ZIPA = std::string("EasyAntiCheat.zip");
const inline auto GH_INJ_ZIPW = std::wstring(L"EasyAntiCheat.zip");

const inline auto GH_INJ_LOGA = std::string("EasyAntiCheat_Log.txt");
const inline auto GH_INJ_LOGW = std::wstring(L"EasyAntiCheat_Log.txt");

const inline auto GH_HELP_URLA = std::string("");
const inline auto GH_HELP_URLW = std::wstring(L"");

const inline auto GH_DOWNLOAD_PREFIXA = std::string("");
const inline auto GH_DOWNLOAD_PREFIXW = std::wstring(L"");

const inline auto GH_DOWNLOAD_SUFFIXA = std::string("/EasyAntiCheat.zip");
const inline auto GH_DOWNLOAD_SUFFIXW = std::wstring(L"/EasyAntiCheat.zip");

const inline auto GH_VERSION_URLA = std::string("");
const inline auto GH_VERSION_URLW = std::wstring(L"");
