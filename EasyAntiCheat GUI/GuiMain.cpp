	...
	: QMainWindow(parent)
{
	...
	{
		emit StatusBox(false, "Failed to enable debug privileges. This might affect the functionality of the anticheat.");
	}
	...
	pxm_banner	= QPixmap(":/GuiMain/eac_resource/EAC Banner.png");
	pxm_lul		= QPixmap(":/GuiMain/eac_resource/EAC Icon.png");
	pxm_generic = QPixmap(":/GuiMain/eac_resource/Generic Icon.png");
	pxm_error	= QPixmap(":/GuiMain/eac_resource/Error Icon.png");

	if (pxm_banner.isNull() || pxm_lul.isNull() || pxm_generic.isNull() || pxm_error.isNull())
	{
		emit StatusBox(false, "Failed to initialize one or multiple graphic files. This won't affect the functionality of the anticheat.");
	}
	...
	ui.btn_openlog->setIcon(QIcon(":/GuiMain/eac_resource/Log Icon.ico"));
	ui.btn_console->setIcon(QIcon(":/GuiMain/eac_resource/Console.ico"));
	...
	framelessPicker.setWindowIcon(QIcon(":/GuiMain/eac_resource/EAC Icon.ico"));
	...
	framelessScanner.setWindowIcon(QIcon(":/GuiMain/eac_resource/EAC Icon.ico"));
...
bool GuiMain::platformCheck()
{
	...
	{
		StatusBox(false, "\"EasyAntiCheat_x64.exe\" is missing.\n");
...
void GuiMain::default_settings()
{
	...
	ui.cmb_proc->setEditText("GTFO.exe");
	ui.txt_pid->setText("1234");
	ignoreUpdate			= false;
...
QTreeWidgetItem * GuiMain::add_file_to_list(QString path, bool active, int flag)
{
	...
	if (is_dot_net)
	{
		...
		btn_options->setIcon(QIcon(":/GuiMain/eac_resource/cog.ico"));
...
void GuiMain::inject_file()
{
	...
	{
		emit StatusBox(false, "The EasyAntiCheat library couldn't be found or wasn't loaded correctly.");
...
void GuiMain::update()
{
	...
	ui.btn_version->setToolTip("Holy shit, your version is perfect.");
