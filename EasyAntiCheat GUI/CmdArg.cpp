...
int CmdArg(int argc, const wchar_t * const argv[], bool & silent)
{
	...
	{
		printf("Failed to enable debug privileges. This might affect the functionality of the anticheat.\n");
	}
...
void help()
{
	...
	printf("\t-wait\n");
	printf("\t\tIf specified the anticheat waits for the target process to start.\n\n");

	printf("\t-log\n");
	printf("\t\tIf specified the anticheat generates an error log if the injection fails.\n\n");

	printf("\t-silent\n");
	printf("\t\tIf specified the no console will be spawned and thus no debug output generated.\n\n");

	printf("\t-delay [value in ms]\n");
	printf("\t\tIf specified the anticheat waits for specified amount in milliseconds before the injection.\n");
	printf("\t\tThe default value is 0ms.\n\n");

	printf("\t-timeout [value in ms]\n");
	printf("\t\tThis argument specifies how long the anticheat waits for the shellcode and DllMain to execute.\n");
	...
	printf("\t-hijack\n");
	printf("\t\tIf set the anticheat will try to hijack a handle to the target process instead of opening a new one.\n\n");
	...
	printf("\t-version\n");
	printf("\t\tThis command prints the current version of the anticheat.\n\n");
}