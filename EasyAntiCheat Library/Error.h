...
#define	INJ_ERR_SM86_EXE_MISSING			0x00000047	//internal error					: -						: "EasyAntiCheat SM_86.exe" is missing, this file is required for import resolving
...
#define SR_SWHEX_ERR_SWHEX_EXT_ERROR		0x1030000B	//SM_EXE_FILENAME.exe	: "EasyAntiCheat SM_XX.exe" error code, 0x30100001 - 0x30100006 (see below) or win32 exception
...
#define SR_KC_ERR_KC_EXT_ERROR			0x1050000E	//SM_EXE_FILENAME.exe	: "EasyAntiCheat SM_XX.exe" error code, 0x50100001 - 0x50100006 (see below) or win32 exception
...
//EasyAntiCheat SM_XX.exe errors:

												//Source	:	error description

#define SM_ERR_INVALID_ARGC	0x30000001			//main		:	EasyAntiCheat SM_XX.exe was called with the wrong amount of arguments
#define SM_ERR_INVALID_ARGV	0x30000002			//main		:	EasyAntiCheat SM_XX.exe was called with invalid arguments

////////////////////////////////////////////////////////////
//EasyAntiCheat SM_XX.exe specific errors:
...
#define HOOK_SCAN_ERR_CANT_GET_OWN_MODULE_PATH		0x50000006	//GetOwnModulePath		: unable to obtain path to the EasyAntiCheat directory
...
#define DNP_ERR_REMOTE_LOADER_MISSING	0x60000007	//internal error		: -						: "EasyAntiCheat DNP_x64/86.dll" is missing
